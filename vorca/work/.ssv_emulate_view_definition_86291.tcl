...
create_library_set -name default_emulate_libset_max -timing [list ../Tech_files/slow.lib]
create_library_set -name default_emulate_libset_min -timing [list ../Tech_files/slow.lib]
