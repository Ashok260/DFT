...
create_library_set -name default_emulate_libset_max -timing [list /jk/Genus/Genus_CUI_RAK/LIB/CDK_R512x16.lib]
create_library_set -name default_emulate_libset_min -timing [list /jk/Genus/Genus_CUI_RAK/LIB/CDK_R512x16.lib]
