...
create_library_set -name default_emulate_libset_max -timing [list ../LIBS/slow.lib]
create_library_set -name default_emulate_libset_min -timing [list ../LIBS/slow.lib]
