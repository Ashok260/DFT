...
create_library_set -name default_emulate_libset_max -timing [list ../TECHFILES/NangateOpenCellLibrary_slow_conditional_ccs.lib]
create_library_set -name default_emulate_libset_min -timing [list ../TECHFILES/NangateOpenCellLibrary_slow_conditional_ccs.lib]
