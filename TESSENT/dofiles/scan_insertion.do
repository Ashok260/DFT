...
set NETLIST_PATH "../run/NETLIST"
set VERILOG_FILE "your_design_opt.v"      ;# Update with your netlist file
set TOP_MODULE   "your_design"            ;# Update with your top module name
set CLK          "your_clk"               ;# Update with your clock signal name

# Output and report directories
set OUT_DIR "../run/outputs/${TOP_MODULE}_OUTPUTS"
set RPT_DIR "../run/reports/${TOP_MODULE}_REPORTS"

# Cell library for scan insertion (update path as needed)
set CELL_LIB_PATH "../TECHFILES/test_Nangate.mdt"
