...
//          Version: 2022.4
//       Created on: Tue Jun 10 16:36:34 IST 2025
//-------------------------------------------------
...
Module memlibc_memory_bist_assembly {
   ...
   Attribute icl_extraction_date = "Tue Jun 10 16:36:34 IST 2025";
   Attribute created_by_tessent_icl_extract = "true";
   Attribute tessent_design_id = "rtl";
   Attribute tessent_design_level = "sub_block";
   Instance mem_container_inst_m1_mem_inst Of rd3_512x16 {
      InputPort A1[8] = mem_container_inst_m1_mem_inst_interface_inst.A1[8];
      InputPort A1[7] = mem_container_inst_m1_mem_inst_interface_inst.A1[7];
      InputPort A1[6] = mem_container_inst_m1_mem_inst_interface_inst.A1[6];
      InputPort A1[5] = mem_container_inst_m1_mem_inst_interface_inst.A1[5];
      InputPort A1[4] = mem_container_inst_m1_mem_inst_interface_inst.A1[4];
      InputPort A1[3] = mem_container_inst_m1_mem_inst_interface_inst.A1[3];
      InputPort A1[2] = mem_container_inst_m1_mem_inst_interface_inst.A1[2];
      InputPort A1[1] = mem_container_inst_m1_mem_inst_interface_inst.A1[1];
      InputPort A1[0] = mem_container_inst_m1_mem_inst_interface_inst.A1[0];
      InputPort A2[8] = mem_container_inst_m1_mem_inst_interface_inst.A2[8];
      InputPort A2[7] = mem_container_inst_m1_mem_inst_interface_inst.A2[7];
      InputPort A2[6] = mem_container_inst_m1_mem_inst_interface_inst.A2[6];
      InputPort A2[5] = mem_container_inst_m1_mem_inst_interface_inst.A2[5];
      InputPort A2[4] = mem_container_inst_m1_mem_inst_interface_inst.A2[4];
      InputPort A2[3] = mem_container_inst_m1_mem_inst_interface_inst.A2[3];
      InputPort A2[2] = mem_container_inst_m1_mem_inst_interface_inst.A2[2];
      InputPort A2[1] = mem_container_inst_m1_mem_inst_interface_inst.A2[1];
      InputPort A2[0] = mem_container_inst_m1_mem_inst_interface_inst.A2[0];
      InputPort CE1 = BIST_CLK;
      InputPort CE2 = BIST_CLK;
...
Module rd3_512x16 {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec223/DFT_TESSENT/TESSENT/Memory_Templates/DP_SRAM_rd3_512x16/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/rd3_512x16.icl'
   DataInPort A1[8:0] {
...
Module memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1 {
   // ICL module read from source on or near line 25 of file '/home/01fe21bec223/DFT_TESSENT/TESSENT/Memory_Templates/DP_SRAM_rd3_512x16/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1.icl'
   ClockPort BIST_CLK;
   ...
   Attribute tessent_signature = "55423442fa580e255d62b62e7e06a77a";
   ...
   Attribute tessent_memory_control_inputs_list = 
       "OEB1 OUTPUTENABLE ACTIVELOW OEB2 OUTPUTENABLE ACTIVELOW CSB1 SELECT ACTIVELOW CSB2 SELECT ACTIVELOW"
       ;
...
Module memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller {
   // ICL module read from source on or near line 26 of file '/home/01fe21bec223/DFT_TESSENT/TESSENT/Memory_Templates/DP_SRAM_rd3_512x16/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller.icl'
   ClockPort BIST_CLK;
   ...
   Attribute tessent_signature = "b2db46b4886e000dde69d36fc9beb2a0";
   Attribute tessent_ignore_during_icl_verification = "on";
   Attribute keep_active_during_scan_test = "false";
   Attribute tessent_use_in_dft_specification = "false";
   Attribute tessent_bist_clk_persistent_cell_output_list = 
   ...
   ScanRegister PORT_COUNTER_FREEZE_REG[0:0] {
      ScanInSource STOP_ERROR_CNT_REG_HW[11];
      RefEnum OnOff;
   }
   ScanRegister PORT_COUNTER_REG[0:0] {
      ScanInSource PORT_COUNTER_FREEZE_REG[0];
   }
   ...
   ScanMux CONTROLLER_SETUP_CHAIN SelectedBy MBISTPG_EN, SETUP_MODE[2:0] {
      1'b1, 3'b00x : PORT_COUNTER_REG[0];
   }
...
Module memlibc_memory_bist_assembly_rtl_tessent_mbist_bap {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec223/DFT_TESSENT/TESSENT/Memory_Templates/DP_SRAM_rd3_512x16/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/memlibc_memory_bist_assembly_rtl_tessent_mbist_bap.icl'
   ResetPort reset {
      ActivePolarity 0;
   }
...
Module memlibc_memory_bist_assembly_rtl_tessent_sib_2 {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec223/DFT_TESSENT/TESSENT/Memory_Templates/DP_SRAM_rd3_512x16/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_ijtag.instrument/memlibc_memory_bist_assembly_rtl_tessent_sib_2.icl'
   ResetPort ijtag_reset {
      ActivePolarity 0;
   }
   SelectPort ijtag_sel;
...
Module memlibc_memory_bist_assembly_rtl_tessent_sib_1 {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec223/DFT_TESSENT/TESSENT/Memory_Templates/DP_SRAM_rd3_512x16/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_ijtag.instrument/memlibc_memory_bist_assembly_rtl_tessent_sib_1.icl'
   ResetPort ijtag_reset {
      ActivePolarity 0;
   }
   SelectPort ijtag_sel;
