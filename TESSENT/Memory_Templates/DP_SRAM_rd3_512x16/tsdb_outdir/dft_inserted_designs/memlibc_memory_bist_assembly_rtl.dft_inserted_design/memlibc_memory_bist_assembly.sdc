...
proc tessent_set_memory_bist_non_modal {} {  
  ...
  set_multicycle_path -hold 1 \
      ...
      -to [tessent_get_cells [dict get $mbist_info mbist1 inst]/MBISTPG_ADD_GEN/AY_ADD_REG*] 
  set_multicycle_path -setup 2 \
      -from [tessent_get_cells [dict get $mbist_info mbist1 inst]/MBISTPG_PORT_COUNTER/PORT_COUNTER*] \
  ...
  set_multicycle_path -setup 1 \
      -from [tessent_get_cells [dict get $mbist_info mbist1 inst]/MBISTPG_PORT_COUNTER/PORT_COUNTER*] \
      -to [tessent_get_cells [dict get $mbist_info mbist1 inst]/MBISTPG_PORT_COUNTER/PORT_COUNTER*] 
...
proc tessent_get_optimize_instances {} {
  set optimize_instance_list {
    ...
    mem_container_inst/memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller_inst/MBISTPG_PORT_COUNTER
