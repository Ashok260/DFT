...
module memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1 (
  ...
  input  wire [15:0] I1_IN,
  input  wire [15:0] I2_IN,
  input  wire [15:0] O1,
  input  wire [15:0] O2,
  input  wire        TCK,
  input  wire        BIST_CMP,
...
wire        CMP_EN;
wire [15:0] BIST_WRITE_DATA_REP;
wire [15:0] BIST_WRITE_DATA_INT;
reg         BIST_INPUT_SELECT;
wire        BIST_EN_RST;
wire        BIST_CLK_INT;
wire        BIST_CLK_OR_TCK;
wire [15:0] BIST_EXPECT_DATA_REP;
wire [15:0] BIST_EXPECT_DATA_INT;
wire        BIST_CLK_EN;
wire        GO_EN;
...
wire [0:0]  ERROR;
wire [0:0]  ERROR_R;
wire [15:0] RAW_CMP_STAT;
wire [15:0] DATA_TO_MEM;
reg  [15:0] DATA_FROM_MEM;
wire [15:0] DATA_FROM_MEM_EXP;
wire        WEB1_TEST_IN;
reg         WEB1_NOT_GATED;
wire        WEB1_TO_MUX;
wire        WEB2_TEST_IN;
...
wire [8:0]  A1_TEST_IN;
wire [8:0]  A2_TEST_IN;
wire [15:0] I1_TEST_IN;
wire [15:0] I2_TEST_IN;
wire [15:0] TEST_PORT0_READ_DATA;
wire [15:0] TEST_PORT1_READ_DATA;
wire        USE_DEFAULTS;
...
wire [15:0] GO_ID_REG_MUX, BIST_SHIFT_COLLAR_MUX;
wire [15:0] GO_ID_REG_MUX_SEL ;
wire GO_ID_REG_CLR;
...
// Instantiate persistent GO_ID_REG_MUX cells }}}
   assign GO_ID_REG_MUX_SEL = (GO_ID_REG & {16{GO_ID_FEEDBACK_EN}})  | {16 {HOLD_OR_RESET | FREEZE_GO_ID }};
   assign BIST_SHIFT_COLLAR_MUX = ((~MCP_BOUNDING_EN) & BIST_SHIFT_COLLAR) ? {SI,GO_ID_REG[15:1]} : GO_ID_REG;
