...
//          Version: 2022.4
//       Created on: Tue Jun 10 16:36:32 IST 2025
//--------------------------------------------------------------------------
...
module memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller_assembly(LV_TM, 
                                                                             ...
                                                                             tck, 
                                                                             so);
  input  [15:0] m1_inst_I1, m1_inst_I2;
  ...
  input  LV_TM, MEM_BYPASS_EN, SCAN_SHIFT_EN, MCP_BOUNDING_EN, clk_BIST_CLK, 
         ...
         update_en, tck;
  output [15:0] m1_inst_O1, m1_inst_O2;
  output BIST_ON, BIST_DONE, BIST_GO, so;

  wire [15:0] m1_interface_instance_I1, m1_interface_instance_I2;
  ...
  memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1 m1_interface_instance(
      ...
      .A1_IN(m1_inst_A1[8:0]), .A2_IN(m1_inst_A2[8:0]), .I1_IN(m1_inst_I1[15:0]), 
      .I2_IN(m1_inst_I2[15:0]), .O1(m1_inst_O1), .O2(m1_inst_O2), .TCK(to_interfaces_tck), 
