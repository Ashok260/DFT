      ...
      case (_pat_type)
         ...
         3'b011:  begin // status message vector
            ...
            case (_message_index)
               ...
               66: begin
                  if (_found_fail_per_cycle == 1) begin
                    $display($realtime, "ns: Previous scan out : pin ijtag_so , ICL register = mem_container_inst_memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller_inst.PORT_COUNTER_FREEZE_REG[0] ");
                  end
               end
               67: begin
                  if (_found_fail_per_cycle == 1) begin
