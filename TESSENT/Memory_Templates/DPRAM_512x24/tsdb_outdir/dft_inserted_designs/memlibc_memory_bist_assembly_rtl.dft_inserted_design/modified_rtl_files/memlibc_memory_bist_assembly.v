/* Generated by Tessent Shell 2022.4 at Tue Jun 03 17:02:54 IST 2025 */
module memlibc_memory_bist_assembly(BIST_CLK, m1_A1, m1_A2, m1_WEB1, m1_WEB2, m1_CSB1, 
  ...
  memlibc_memory_bist_assembly_mem_container mem_container_inst(
      ...
      .m1_mem_inst_O2(m1_O2), .BIST_HOLD(BIST_HOLD), .BIST_SETUP(BIST_SETUP[0]), 
...
module memlibc_memory_bist_assembly_mem_container(m1_A1, m1_A2, BIST_CLK, m1_WEB1, 
  ...
  input  [8:0] m1_A1, m1_A2;
  input  BIST_CLK, m1_WEB1, m1_WEB2, m1_CSB1, m1_CSB2;
  output [23:0] m1_mem_inst_O1, m1_mem_inst_O2;
  ...
  wire [8:0] m1_mem_inst_interface_inst_A1, m1_mem_inst_interface_inst_A2;
  wire MEM0_BIST_COLLAR_SI, BIST_SO, BIST_GO, BIST_COLLAR_DIAG_EN, 
       ...
       ERROR_CNT_ZERO, MBISTPG_RESET_REG_SETUP2, WEB1, WEB2, CSB1, CSB2;
  wire [23:0] m1_mem_inst_interface_inst_I1, m1_mem_inst_interface_inst_I2;
  DPRAM_512x24 m1_mem_inst(
      .A1(m1_mem_inst_interface_inst_A1), .A2(m1_mem_inst_interface_inst_A2), .CE1(BIST_CLK), .CE2(BIST_CLK), .WEB1(WEB1), .WEB2(WEB2), 
      .OEB1(1'b0), .OEB2(1'b0), .CSB1(CSB1), .CSB2(CSB2), .I1(m1_mem_inst_interface_inst_I1), .I2(m1_mem_inst_interface_inst_I2), 
  ...
  memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller_inst(
      ...
      .MBISTPG_GO(MBISTPG_GO), .MBISTPG_DONE(MBISTPG_DONE), .BIST_ON_TO_COLLAR(BIST_ON_TO_COLLAR)
  );

  memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1 m1_mem_inst_interface_inst(
      .WEB1_IN(m1_WEB1), .WEB2_IN(m1_WEB2), .CSB1_IN(m1_CSB1), .CSB2_IN(m1_CSB2), 
      .A1_IN(m1_A1[8:0]), .A2_IN(m1_A2[8:0]), .I1_IN(m1_I1[23:0]), .I2_IN(m1_I2[23:0]), 
      .O1(m1_mem_inst_O1), .O2(m1_mem_inst_O2), .TCK(to_interfaces_tck), .BIST_CMP(BIST_CMP), 
      .INCLUDE_MEM_RESULTS_REG(INCLUDE_MEM_RESULTS_REG), .BIST_WRITEENABLE(BIST_WRITEENABLE), 
      ...
      .A1(m1_mem_inst_interface_inst_A1), .A2(m1_mem_inst_interface_inst_A2), .I1(m1_mem_inst_interface_inst_I1), 
      .I2(m1_mem_inst_interface_inst_I2), .SCAN_OBS_FLOPS(), .BIST_SO(BIST_SO), 
      .BIST_GO(BIST_GO)
  );
endmodule
