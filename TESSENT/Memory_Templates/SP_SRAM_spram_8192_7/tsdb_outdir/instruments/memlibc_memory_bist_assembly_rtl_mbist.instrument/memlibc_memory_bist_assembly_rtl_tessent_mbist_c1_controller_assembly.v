...
//          Version: 2022.4
//       Created on: Tue Jun  3 17:00:59 IST 2025
//--------------------------------------------------------------------------
...
module memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller_assembly(LV_TM, 
  ...
  output [6:0] m1_inst_O;
  output BIST_ON, BIST_DONE, BIST_GO, so;

  wire [12:0] m1_interface_instance_A;
  wire [6:0] BIST_ROW_ADD, m1_interface_instance_I;
  wire [5:0] BIST_COL_ADD;
  ...
  spram_8192_7 m1_inst(
      .CEB(clk_BIST_CLK), .WEB(WEB), .OEB(m1_inst_OEB), .CSB(CSB), .A(m1_interface_instance_A), 
  ...
  memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1 m1_interface_instance(
      .WEB_IN(m1_inst_WEB), .CSB_IN(m1_inst_CSB), .A_IN(m1_inst_A[12:0]), .I_IN(m1_inst_I[6:0]), 
