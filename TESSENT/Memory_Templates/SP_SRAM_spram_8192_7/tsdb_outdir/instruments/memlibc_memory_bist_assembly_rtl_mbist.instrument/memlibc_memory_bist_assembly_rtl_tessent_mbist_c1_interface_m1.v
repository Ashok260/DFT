...
wire        CMP_EN;
wire [6:0]  BIST_WRITE_DATA_REP;
wire [6:0]  BIST_WRITE_DATA_INT;
reg         BIST_INPUT_SELECT;
wire        BIST_EN_RST;
wire        BIST_CLK_INT;
wire        BIST_CLK_OR_TCK;
wire [6:0]  BIST_EXPECT_DATA_REP;
wire [6:0]  BIST_EXPECT_DATA_INT;
wire        BIST_CLK_EN;
wire        GO_EN;
...
wire [0:0]  ERROR;
wire [0:0]  ERROR_R;
wire [6:0]  RAW_CMP_STAT;
wire [6:0]  DATA_TO_MEM;
wire [6:0]  DATA_FROM_MEM;
wire [6:0]  DATA_FROM_MEM_EXP;
wire        WEB_TEST_IN;
reg         WEB_NOT_GATED;
wire        WEB_TO_MUX;
wire        CSB_TEST_IN;
...
wire [6:0] GO_ID_REG_MUX, BIST_SHIFT_COLLAR_MUX;
wire [6:0] GO_ID_REG_MUX_SEL ;
wire GO_ID_REG_CLR;
...
// Instantiate persistent GO_ID_REG_MUX cells }}}
   assign GO_ID_REG_MUX_SEL = (GO_ID_REG & {7{GO_ID_FEEDBACK_EN}})  | {7 {HOLD_OR_RESET | FREEZE_GO_ID }};
   assign BIST_SHIFT_COLLAR_MUX = ((~MCP_BOUNDING_EN) & BIST_SHIFT_COLLAR) ? {SI,GO_ID_REG[6:1]} : GO_ID_REG;
