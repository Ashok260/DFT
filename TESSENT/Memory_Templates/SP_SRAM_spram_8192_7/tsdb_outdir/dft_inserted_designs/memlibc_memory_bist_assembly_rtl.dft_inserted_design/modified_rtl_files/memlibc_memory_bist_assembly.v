/* Generated by Tessent Shell 2022.4 at Tue Jun 03 17:00:52 IST 2025 */
...
module memlibc_memory_bist_assembly_mem_container(m1_A, BIST_CLK, m1_WEB, m1_CSB, 
  ...
  wire [12:0] m1_mem_inst_interface_inst_A;
  ...
  wire [6:0] m1_mem_inst_interface_inst_I;
  spram_8192_7 m1_mem_inst(
      .A(m1_mem_inst_interface_inst_A), .CEB(BIST_CLK), .WEB(WEB), .OEB(1'b0), .CSB(CSB), .I(m1_mem_inst_interface_inst_I), 
      .O(m1_mem_inst_O)
  );
  ...
  memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1 m1_mem_inst_interface_inst(
      .WEB_IN(m1_WEB), .CSB_IN(m1_CSB), .A_IN(m1_A[12:0]), .I_IN(m1_I[6:0]), .O(m1_mem_inst_O), 
