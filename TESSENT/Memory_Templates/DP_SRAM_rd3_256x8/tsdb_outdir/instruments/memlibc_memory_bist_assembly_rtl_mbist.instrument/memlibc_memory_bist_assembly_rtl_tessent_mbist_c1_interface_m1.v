...
module memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1 (
  ...
  input  wire [7:0] A2_IN,
  input  wire [7:0] I1_IN,
  input  wire [7:0] I2_IN,
  input  wire [7:0] O1,
  input  wire [7:0] O2,
  input  wire       TCK,
  input  wire       BIST_CMP,
...
wire [7:0] I1_TEST_IN;
wire [7:0] I2_TEST_IN;
wire [7:0] TEST_PORT0_READ_DATA;
wire [7:0] TEST_PORT1_READ_DATA;
wire       USE_DEFAULTS;
...
//-----------------------
  ...
  always @ (posedge BIST_CLK_INT or negedge BIST_ASYNC_RESETN) begin
    if (~BIST_ASYNC_RESETN)
      SCAN_OBS_FLOPS    <= 7'b0000000;
    else
      SCAN_OBS_FLOPS    <= {7{MEM_BYPASS_EN} } & {
                          WEB1_NOT_GATED       ^ WEB2_NOT_GATED       ^ CSB1_NOT_GATED       ,
                          CSB2_NOT_GATED       ^ A1[7]                ^ A1[6]                ,
                          A1[5]                ^ A1[4]                ^ A1[3]                ,
                          A1[2]                ^ A1[1]                ^ A1[0]                ,
                          A2[7]                ^ A2[6]                ^ A2[5]                ,
                          A2[4]                ^ A2[3]                ^ A2[2]                ,
...
//--------------------------
   ...
   wire   [5:0]                     BIST_ROW_ADD_SHADOW_PORT1;
   ...
   wire   [5:0]                     BIST_ROW_ADD_SHADOW_PORT2;
