...
#          Version: 2022.4
#       Created on: Sat Jun 21 12:23:24 IST 2025
#--------------------------------------------------------------------------
...
proc tessent_set_default_variables {} {
  ...
  set mbist_info {
    bap1 {
      ...
      inst sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_inst
      tck_type port
      tck ijtag_tck
      to_bist toBist_reg
    ...
    mbist1 {
      inst sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst
      bap_id bap1
      bist_port 0
      async_interface_present false
    }
    mbist1_m1 {inst u_bank0_my_sram_interface_inst}
    mbist1_m1_memory {inst u_bank0_my_sram}
    mbist1_m2 {inst u_bank1_my_sram_interface_inst}
    mbist1_m2_memory {inst u_bank1_my_sram}
  }
...
global time_unit_multiplier tessent_clock_mapping tessent_unmapped_functional_clocks
  create_clock [tessent_get_ports [list {CLK}]]  \
    ...
    -name $tessent_clock_mapping(CLK) -add


  set tessent_unmapped_functional_clocks [lsort -unique [concat $tessent_unmapped_functional_clocks [list CLK]]]
}
proc tessent_set_ijtag_non_modal {} {  
  ...
  set scan_resource_sib_list {
    sram_sp_16384d_36w_16m_8b_rtl_tessent_sib_sti_inst/to_enable_int*
  }
...
proc tessent_set_memory_bist_non_modal {} {  
  ...
  ## Constraints for memory_bist controller 'sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst'
  ...
  set_multicycle_path -setup 2 \
      ...
      -to [tessent_get_clocks $tessent_clock_mapping(CLK)] 
  set_multicycle_path -hold 1 \
      -from [tessent_get_cells [dict get $mbist_info mbist1 inst]/MBISTPG_CTL_COMP/STOP_ON_ERROR*] \
      -to [tessent_get_clocks $tessent_clock_mapping(CLK)] 
  ...
  set_multicycle_path -hold 1 \
      ...
      -through [tessent_get_pins [dict get $mbist_info mbist1 inst]/tessent_persistent_cell_BIST_RUN/Y] 
  set_multicycle_path -setup 2 \
      -from [tessent_get_clocks $tessent_clock_mapping(CLK)] \
  ...
  ## Constraints for memory_bist interface 'u_bank0_my_sram_interface_inst'
  ##   of controller 'sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst'
  ...
  set_multicycle_path -setup 2 -start \
      -from [tessent_get_clocks [list $tessent_clock_mapping(CLK)]] \
  ...
  ## Constraints for memory_bist interface 'u_bank1_my_sram_interface_inst'
  ##   of controller 'sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst'
  
  set_multicycle_path -setup 2 \
      -from [tessent_get_cells [dict get $mbist_info mbist1_m2 inst]/BIST_INPUT_SELECT*] \
      -through [tessent_get_pins [dict get $mbist_info mbist1_m2 inst]/tessent_persistent_cell_BIST_INPUT_SELECT_INT/Y] 
  set_multicycle_path -hold 1 \
      -from [tessent_get_cells [dict get $mbist_info mbist1_m2 inst]/BIST_INPUT_SELECT*] \
      -through [tessent_get_pins [dict get $mbist_info mbist1_m2 inst]/tessent_persistent_cell_BIST_INPUT_SELECT_INT/Y] 
  set_multicycle_path -setup 2 -start \
      ...
      -through [tessent_get_cells [list  \
          ...
          [dict get $mbist_info mbist1 inst]/MBISTPG_POINTER_CNTRL/INST_POINTER* \
          [dict get $mbist_info mbist1 inst]/MBISTPG_FSM/RUNTEST_EN_REG_reg?3?]] \
      -to   [tessent_get_cells  [dict get $mbist_info mbist1_m2 inst]/MBISTPG_STATUS/GO_ID_REG*]  
  set_multicycle_path -hold  1 -end   \
      -from [tessent_get_clocks [list $tessent_clock_mapping(CLK)]] \
      -through [tessent_get_cells [list  \
          [dict get $mbist_info mbist1 inst]/MBISTPG_ADD_GEN/AX_ADD_REG* \
...
proc tessent_set_memory_bist_modal {} {  
  ...
  set_false_path -from [remove_from_collection [all_inputs] [tessent_get_ports [list CLK ijtag_ce ijtag_se ijtag_si ijtag_tck ijtag_ue]] ] 
...
proc tessent_kill_functional_paths {{verbose OFF}} {
  ...
  set funcFlops [remove_from_collection $funcFlops [ list  \
    [tessent_get_mem_cells {u_bank0_my_sram}] \
    [tessent_get_mem_cells {u_bank1_my_sram}] ]]
...
proc tessent_get_preserve_instances {select} {
  ...
  set icl_design_instance_list {
    ...
    u_bank0_my_sram_interface_inst
    u_bank1_my_sram_interface_inst
  }
...
proc tessent_get_optimize_instances {} {
  set optimize_instance_list {
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_inst/sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_controller_sib_ctl_bypass_inst
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_inst/sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_controller_sib_inst0
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_inst/sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_controller_sib_tdr_bypass_inst
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_inst/tdr_inst
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst/MBISTPG_ADD_FORMAT
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst/MBISTPG_ADD_GEN
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst/MBISTPG_CTL_COMP
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst/MBISTPG_DATA_GEN
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst/MBISTPG_FSM
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst/MBISTPG_POINTER_CNTRL
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst/MBISTPG_REPEAT_LOOP_CNTRL
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_inst/MBISTPG_SIGNAL_GEN
    u_bank0_my_sram_interface_inst/MBISTPG_STATUS
    u_bank1_my_sram_interface_inst/MBISTPG_STATUS
  }
...
set tessent_old_2_new_proc_name_mapping {
  {tessent_constrain_sram_sp_16384d_36w_16m_8b_non_modal tessent_set_non_modal no}
  {tessent_constrain_sram_sp_16384d_36w_16m_8b_mentor_memory_bist_non_modal tessent_set_memory_bist_non_modal no}
  {tessent_constrain_sram_sp_16384d_36w_16m_8b_mentor_ijtag_non_modal tessent_set_ijtag_non_modal no}
  {tessent_constrain_sram_sp_16384d_36w_16m_8b_mentor_memory_bist_modal tessent_set_memory_bist_modal no}
}
