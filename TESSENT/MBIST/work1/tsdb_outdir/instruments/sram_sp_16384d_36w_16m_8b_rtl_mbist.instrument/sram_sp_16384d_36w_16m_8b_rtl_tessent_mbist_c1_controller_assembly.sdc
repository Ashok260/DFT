...
global time_unit_multiplier tessent_clock_mapping tessent_unmapped_functional_clocks
  create_clock [tessent_get_ports [list {clk_CLK}]]  \
    -period [expr 10.0*$time_unit_multiplier] \
    -name $tessent_clock_mapping(clk_CLK) -add


  set tessent_unmapped_functional_clocks [lsort -unique [concat $tessent_unmapped_functional_clocks [list clk_CLK]]]
}
...
proc tessent_set_memory_bist_non_modal {} {  
  ...
  set_multicycle_path -setup 2 \
      ...
      -to [tessent_get_clocks $tessent_clock_mapping(clk_CLK)] 
  set_multicycle_path -hold 1 \
      -from [tessent_get_cells [dict get $mbist_info mbist1 inst]/MBISTPG_CTL_COMP/STOP_ON_ERROR*] \
      -to [tessent_get_clocks $tessent_clock_mapping(clk_CLK)] 
  ...
  set_multicycle_path -hold 1 \
      ...
      -through [tessent_get_pins [dict get $mbist_info mbist1 inst]/tessent_persistent_cell_BIST_RUN/Y] 
  set_multicycle_path -setup 2 \
      -from [tessent_get_clocks $tessent_clock_mapping(clk_CLK)] \
  ...
  set_multicycle_path -setup 2 -start \
      -from [tessent_get_clocks [list $tessent_clock_mapping(clk_CLK)]] \
...
proc tessent_set_memory_bist_modal {} {  
  ...
  set_false_path -from [remove_from_collection [all_inputs] [tessent_get_ports [list capture_en clk_CLK shift_en si tck update_en]] ] 
...
set tessent_old_2_new_proc_name_mapping {
  {tessent_constrain_sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_assembly_mentor_memory_bist_modal tessent_set_memory_bist_modal no}
  {tessent_constrain_sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_assembly_non_modal tessent_set_non_modal no}
  {tessent_constrain_sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_assembly_mentor_memory_bist_non_modal tessent_set_memory_bist_non_modal no}
  {tessent_constrain_sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_assembly_mentor_ijtag_non_modal tessent_set_ijtag_non_modal no}
}
