...
-          Version: 2022.4                                                       -
-       Created on: Sat Jun 21 12:23:10 IST 2025                                 -
----------------------------------------------------------------------------------
...
module sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller (
  ...
  input  wire [1:0] BIST_COLLAR_GO, // Status bit from collars with local comparators
  ...
  output wire [6:0] BIST_ROW_ADD, // row address
...
//------------------------
    ...
    sram_sp_16384d_36w_16m_8b_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_MBIST_NTC_RETIMING_CELL_CLK_EN ( 
    ...
    TLATNTSCAX8 tessent_persistent_cell_GATING_BIST_CLK (
        .CK         ( BIST_CLK                    ),
        .SE         ( 1'b0         ),
        .E          ( BIST_EN_INT & (~MCP_BOUNDING_EN)           ),
        .ECK        ( BIST_CLK_GATED              )
    );
    sram_sp_16384d_36w_16m_8b_rtl_tessent_clk_mux2 tessent_persistent_cell_BIST_CLK_INT (
        .s          ( INJECT_TCK                                 ),
        .a          ( BIST_CLK_GATED                             ),
        .b          ( TCK                                        ),
        .y          ( BIST_CLK_INT                               )
    ...
    CLKAND2X8 tessent_persistent_cell_AND_MBISTPG_MEM_RST_SYNC (
        .A          ( MBISTPG_MEM_RST                            ),
        .B          ( BIST_ON                                    ),
        .Y          ( MBISTPG_MEM_RST_SYNC                       )
    );

    CLKAND2X8 tessent_persistent_cell_AND_FL_CNT_MODE0_SYNC (
        .A          ( FL_CNT_MODE[0]                             ),
        .B          ( BIST_ON                                    ),
        .Y          ( FL_CNT_MODE0_SYNC                          )
    );
    ...
    sram_sp_16384d_36w_16m_8b_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_MBIST_NTC_RETIMING_CELL_TESTDATA_SELECT ( 
        .rn                         (MBISTPG_ASYNC_RESETN         ), // i
        .clk        ( BIST_CLK     ), // i
    ...
    CLKAND2X8 tessent_persistent_cell_AND_BIST_SI_SYNC (
        .A          ( BIST_SI                                    ),
        .B          ( BIST_SHIFT_SYNC                            ),
        .Y          ( BIST_SI_SYNC                               )
    );
    ...
    CLKAND2X8 tessent_persistent_cell_AND_SHORT_SETUP_SYNC (
    ...
    DLY4X4 tessent_persistent_cell_MBISTPG_DONE (
        .A           (BIST_DONE_PIPE2),
        .Y           (MBISTPG_DONE)
    );
    ...
    assign BIST_COLLAR_EN1_PRE      = BIST_RUN_INT & MEM_SELECT_REG_INT[1] ;
  ...
  assign BIST_ON_TO_BUF           = BIST_EN_RETIME2;  
    CLKAND2X8 tessent_persistent_cell_AND_DEFAULT_MODE (
        .A          ( ~BIST_SETUP[0]                             ),
        .B          ( BIST_ON_TO_BUF                             ),
        .Y          ( DEFAULT_MODE                               )
    );
  ...
  assign BIST_HOLD_R              = BIST_HOLD_INT;            
    DLY4X4 tessent_persistent_cell_BIST_ON (
        .A           (BIST_ON_TO_BUF),
        .Y           (BIST_ON)
    );    
    ...
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_fsm MBISTPG_FSM (
    ...
    DLY4X4 tessent_persistent_cell_BIST_RUN (
        .A           (BIST_RUN_INT),
        .Y           (BIST_RUN)
    );    
  ...
  reg BIST_SI_PIPELINE;
    ...
    // DIAGNOSIS MODE
    //----------------
    CLKAND2X8 tessent_persistent_cell_AND_MBISTPG_DIAG_EN_GATED (
        .A          ( MBISTPG_DIAG_EN                            ),
        .B          ( BIST_ON                                    ),
...
assign CMP_EN = CMP_EN_INT;
    ...
    always @ (posedge BIST_CLK_INT or negedge MBISTPG_ASYNC_RESETN) begin
        if (~MBISTPG_ASYNC_RESETN)
            MEM_SELECT_REG          <= {2{1'b1}};
        else 
        if (BIST_SHIFT_SHORT)
            MEM_SELECT_REG          <= {MEM_SELECT_REG[0:0], MEM_SELECT_REG_SI};
        else
        if ((~BIST_HOLD_R_INT) & CLEAR_DEFAULT)
            MEM_SELECT_REG          <= {2{1'b1}};
    end
    assign MEM_SELECT_REG_SO = MEM_SELECT_REG[1];
    assign MEM_SELECT_REG_INT = MEM_SELECT_REG;

    //------------------------
    // REDUCED ADDRESS COUNT
    //------------------------
    CLKAND2X8 tessent_persistent_cell_AND_MBISTPG_REDUCED_ADDR_CNT_EN_SYNC (
    ...
    //------------------------
    CLKAND2X8 tessent_persistent_cell_AND_MBISTPG_ALGO_MODE_SYNC0 (
        .A          ( MBISTPG_ALGO_MODE[0]                       ),
        .B          ( BIST_ON                                    ),
        .Y          ( MBISTPG_ALGO_MODE_SYNC[0]                  )
    );

    CLKAND2X8 tessent_persistent_cell_AND_MBISTPG_ALGO_MODE_SYNC1 (
    ...
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_pointer_cntrl MBISTPG_POINTER_CNTRL ( 
       .BIST_CLK                                   ( BIST_CLK_INT                              ),
    ...
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_add_gen MBISTPG_ADD_GEN (
       .BIST_CLK                    (BIST_CLK_INT                ),
       .BIST_RUN                    (BIST_RUN                    ),
       .RESET_REG_DEFAULT_MODE      (RESET_REG_DEFAULT_MODE      ),
       .BIST_ASYNC_RESETN           (MBISTPG_ASYNC_RESETN        ),
    ...
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_add_format MBISTPG_ADD_FORMAT (
       .Y_ADDRESS                   (Y_ADDRESS                   ),
       .X_ADDRESS                   (X_ADDRESS                   ),
    ...
    DLY4X4 tessent_persistent_cell_Y1_MINMAX_TRIGGER(
        .A           (Y1_MINMAX_TRIGGER_OUT),
        .Y           (Y1_MINMAX_TRIGGER)
    );    
    DLY4X4 tessent_persistent_cell_X1_MINMAX_TRIGGER(
        .A           (X1_MINMAX_TRIGGER_OUT),
        .Y           (X1_MINMAX_TRIGGER)
    );    

    assign SIGNAL_GEN_SI            = ADD_GEN_SO;
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_signal_gen MBISTPG_SIGNAL_GEN (       
       .BIST_CLK                                   ( BIST_CLK_INT                              ),
       .BIST_ASYNC_RESETN                          ( MBISTPG_ASYNC_RESETN       ),
       .SI                                         (SIGNAL_GEN_SI                              ),
       .BIST_SHIFT_SHORT                           (BIST_SHIFT_SHORT                           ),
    ...
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_data_gen MBISTPG_DATA_GEN (
       //inputs
       .BIST_CLK                    (BIST_CLK_INT                ),
       .BIST_HOLD                   (BIST_HOLD_R_INT             ),
       .BIST_ASYNC_RESETN           (MBISTPG_ASYNC_RESETN        ), 
    ...
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_repeat_loop_cntrl MBISTPG_REPEAT_LOOP_CNTRL (
       .BIST_CLK                                   ( BIST_CLK_INT               ),
       .RESET_REG_SETUP1                           (RESET_REG_SETUP1            ),
       .RESET_REG_DEFAULT_MODE                     (RESET_REG_DEFAULT_MODE      ),
       .LOOP_CMD                                   (LOOP_CMD                    ),
    ...
    DLY4X4 tessent_persistent_cell_LOOPCOUNTMAX_TRIGGER (
        .A           (LOOPCOUNTMAX_TRIGGER_INT),
        .Y           (LOOPCOUNTMAX_TRIGGER)
    );    
    DLY4X4 tessent_persistent_cell_INH_LAST_ADDR_CNT (
    ...
    DLY4X4 tessent_persistent_cell_MBISTPG_GO (
        .A           ( MBISTPG_GO_INT              ),
        .Y           ( MBISTPG_GO   )
    );
    ...
    always @ (negedge TCK or negedge MBISTPG_ASYNC_RESETN) begin
       if (~MBISTPG_ASYNC_RESETN) begin
          ...
          MEM1_BIST_COLLAR_SI_RetimeOut <= TO_COLLAR_SI;
       end
    end
    ...
    always @ (negedge TCK or negedge MBISTPG_ASYNC_RESETN) begin
       if (~MBISTPG_ASYNC_RESETN) begin
          ...
          MEM0_BIST_COLLAR_SI_RetimeOut <= MEM1_BIST_COLLAR_SO;
    ...
    sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_ctl_comp MBISTPG_CTL_COMP (
       ...
       .CMP_EN_R                    ( CMP_EN_R                                  ), // i
       .CMP_EN                      ( CMP_EN_INT                 ), // i
       .BIST_COLLAR_GO              ( BIST_COLLAR_GO                            ), // i [1:0]
       .HOLD_EN                     ( HOLD_EN                                   ), // o
...
endmodule // sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller


/*------------------------------------------------------------------------------
     Module      :  sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_ctl_comp
...
assign SOE_COLLAR_CMP_STAT = BIST_STOP_ON_ERROR_EN ? ((~BIST_COLLAR_GO[0]) | (~BIST_COLLAR_GO[1])) : CMP_EN;
...
assign FL1_RETIME1_IN = FL1; 
    sram_sp_16384d_36w_16m_8b_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_MBIST_NTC_RETIMING_CELL_FL1 ( 
...
endmodule // sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_ctl_comp
 
/*------------------------------------------------------------------------------
     Module      :  sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_pointer_cntrl
...
// NEXT_POINTER persistent buffers {{{
    DLY4X4 tessent_persistent_cell_NEXT_POINTER0 (
        .A           (NEXT_POINTER_TO_BUF[0]      ),
        .Y           (NEXT_POINTER[0]             )
    );    
    DLY4X4 tessent_persistent_cell_NEXT_POINTER1 (
        .A           (NEXT_POINTER_TO_BUF[1]      ),
        .Y           (NEXT_POINTER[1]             )
    );    
    DLY4X4 tessent_persistent_cell_NEXT_POINTER2 (
        .A           (NEXT_POINTER_TO_BUF[2]      ),
        .Y           (NEXT_POINTER[2]             )
    );    
    DLY4X4 tessent_persistent_cell_NEXT_POINTER3 (
...
endmodule // sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_pointer_cntrl
 
/*------------------------------------------------------------------------------
     Module      :  sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_add_format
...
module sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_add_format (
  ...
  input  wire [6:0] X_ADDRESS,
  output wire [5:0] COLUMN_ADDRESS,
  output wire [6:0] ROW_ADDRESS
);
...
endmodule // sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_add_format
 
/*------------------------------------------------------------------------------
     Module      :  sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_add_gen
...
module sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_add_gen (
  ...
  output wire [6:0] X_ADDRESS,
  output wire [5:0] Y_ADDRESS,
  output wire A_EQUALS_B_TRIGGER
);
    wire    [6:0]    AX_ADD_WIRE, BX_ADD_WIRE;
    reg     [6:0]    AX_ADD_REG;
    reg     [6:0]    BX_ADD_REG;
    ...
    wire   [6:0]     X_R, X_RP, X_RCO, X_RCI;
    reg   [6:0]      NEXT_X_ADD_COUNT;
    wire   [6:0]     X_ADD_CNT_TO_BUF;
    wire   [6:0]     X_ADD_CNT;
    wire   [6:0]     X_ADD_CNT_MAX, X_ADD_CNT_MIN;
    ...
    wire   [6:0]     X_ADD_REG_MIN_DEFAULT;
    wire   [6:0]     X_ADD_REG_MAX_DEFAULT;
...
//------------------------------
    ...
    assign X_RP      = (({7{INCX1}} & (~X_R)) | ({7{DECX1}} & X_R));
 
    assign X_RCO     = (X_RCI | X_RP) ;
 
    assign X_RCI     = (~X1_CNT_EN) ? {7{1'b1}}                                                                :
                                      ({X_RCO[5:0], 1'b0 })                                     ;
...
//---------------------------------
  ...
  // Instantiate X_ADD_CNT persistent buffers {{{
    DLY4X4 tessent_persistent_cell_X_ADD_CNT_0 (
        .A           (X_ADD_CNT_TO_BUF[0]),
        .Y           (X_ADD_CNT[0])
    );    
    DLY4X4 tessent_persistent_cell_X_ADD_CNT_1 (
        .A           (X_ADD_CNT_TO_BUF[1]),
        .Y           (X_ADD_CNT[1])
    );    
    DLY4X4 tessent_persistent_cell_X_ADD_CNT_2 (
        .A           (X_ADD_CNT_TO_BUF[2]),
        .Y           (X_ADD_CNT[2])
    );    
    DLY4X4 tessent_persistent_cell_X_ADD_CNT_3 (
        .A           (X_ADD_CNT_TO_BUF[3]),
        .Y           (X_ADD_CNT[3])
    );    
    DLY4X4 tessent_persistent_cell_X_ADD_CNT_4 (
        .A           (X_ADD_CNT_TO_BUF[4]),
        .Y           (X_ADD_CNT[4])
    );    
    DLY4X4 tessent_persistent_cell_X_ADD_CNT_5 (
        .A           (X_ADD_CNT_TO_BUF[5]),
        .Y           (X_ADD_CNT[5])
    );    
    DLY4X4 tessent_persistent_cell_X_ADD_CNT_6 (
  ...
  // Instantiate Y_ADD_CNT persistent buffers {{{
    DLY4X4 tessent_persistent_cell_Y_ADD_CNT_0 (
        .A           (Y_ADD_CNT_TO_BUF[0]),
        .Y           (Y_ADD_CNT[0])
    );    
    DLY4X4 tessent_persistent_cell_Y_ADD_CNT_1 (
        .A           (Y_ADD_CNT_TO_BUF[1]),
        .Y           (Y_ADD_CNT[1])
    );    
    DLY4X4 tessent_persistent_cell_Y_ADD_CNT_2 (
        .A           (Y_ADD_CNT_TO_BUF[2]),
        .Y           (Y_ADD_CNT[2])
    );    
    DLY4X4 tessent_persistent_cell_Y_ADD_CNT_3 (
        .A           (Y_ADD_CNT_TO_BUF[3]),
        .Y           (Y_ADD_CNT[3])
    );    
    DLY4X4 tessent_persistent_cell_Y_ADD_CNT_4 (
        .A           (Y_ADD_CNT_TO_BUF[4]),
        .Y           (Y_ADD_CNT[4])
    );    
    DLY4X4 tessent_persistent_cell_Y_ADD_CNT_5 (
...
//----------------------------------------------
    ...
    assign X_ADD_REG_MIN_DEFAULT    = 7'b0000000;
      
    assign X_ADD_CNT_MIN            = X_ADD_REG_MIN_DEFAULT;
 
    // Algorithm: SMARCH Type: IC
    assign X_ADD_REG_MAX_DEFAULT    = MBISTPG_REDUCED_ADDR_CNT_EN ? 7'b1111111 : 7'b1111111;
 
    assign X_ADD_CNT_MAX            = X_ADD_REG_MAX_DEFAULT;
//----------------------------------------
// Select out bit X register            --
//----------------------------------------
    assign X_ADD_ROT_OUT_DEFAULT    = 3'b110;
...
//------------------------------------
    assign           AX_ADD_WIRE    = 7'b0000000; // Algorithm: SMARCH
 
    assign AX_MASK   =                      (BIST_SHIFT_SHORT)    ? 7'b1111111 :
                      (X_ADD_ROT_OUT == 3'b110)    ? 7'b1111111 :
                      (X_ADD_ROT_OUT == 3'b101)    ? 7'b0111111 :
                      (X_ADD_ROT_OUT == 3'b100)    ? 7'b0011111 :
                      (X_ADD_ROT_OUT == 3'b011)    ? 7'b0001111 :
                      (X_ADD_ROT_OUT == 3'b010)    ? 7'b0000111 :
                      (X_ADD_ROT_OUT == 3'b001)    ? 7'b0000011 :
                                                                    7'b0000001; 
    ...
    always @ (posedge BIST_CLK or negedge BIST_ASYNC_RESETN) begin
        ...
        if (BIST_SHIFT_SHORT | (LAST_TICK & (~BIST_HOLD) & ROT_LF_A_ADD_REG & BIST_RUN))
            AX_ADD_REG              <= (AX_MASK & {AX_ADD_REG[5:0], AX_ROT_IN_SELECTED}) | ((~AX_MASK) & AX_ADD_REG);
        else
        if (LAST_TICK & (~BIST_HOLD) & ROT_RT_A_ADD_REG & BIST_RUN)
            AX_ADD_REG              <= {AX_ROT_RT_IN_SELECTED, AX_ADD_REG[6:1]};
        else begin
...
//------------------------------------
    assign           BX_ADD_WIRE    = 7'b0000000; // Algorithm: SMARCH
 
    assign BX_MASK   =                      (BIST_SHIFT_SHORT)    ? 7'b1111111 :
                      (X_ADD_ROT_OUT == 3'b110)    ? 7'b1111111 :
                      (X_ADD_ROT_OUT == 3'b101)    ? 7'b0111111 :
                      (X_ADD_ROT_OUT == 3'b100)    ? 7'b0011111 :
                      (X_ADD_ROT_OUT == 3'b011)    ? 7'b0001111 :
    ...
    always @ (posedge BIST_CLK or negedge BIST_ASYNC_RESETN) begin
        ...
        if (BIST_SHIFT_SHORT | (LAST_TICK & (~BIST_HOLD) & ROT_LF_B_ADD_REG & BIST_RUN))
            BX_ADD_REG              <= (BX_MASK & {BX_ADD_REG[5:0], BX_ROT_IN_SELECTED}) | ((~BX_MASK) & BX_ADD_REG);
        else begin
...
//------------------------------------------------
    ...
    assign A_SCAN_REGISTER_SI       = AX_ADD_REG[6];
...
//------------------------------------------------
    ...
    assign B_SCAN_REGISTER_SI       = BX_ADD_REG[6];
    assign B_SCAN_REGISTER_SO       = B_SCAN_REGISTER_SI;

    assign B_SCAN_WIRE              = {1'b1, 1'b0};

    assign B_SCAN_REGISTER          = B_SCAN_WIRE;       
endmodule // sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_add_gen
  
 
/*------------------------------------------------------------------------------
     Module      :  sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_fsm
...
endmodule // sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_fsm
 
/*------------------------------------------------------------------------------
     Module      :  sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_signal_gen
...
endmodule // sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_signal_gen
     
/*------------------------------------------------------------------------------
     Module      :  sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_repeat_loop_cntrl
...
endmodule // sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_repeat_loop_cntrl
 
 
/*------------------------------------------------------------------------------
     Module      :  sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_data_gen
...
module sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_data_gen (
  ...
  output wire SO
    ...
    wire             EDATA_SI;
    wire             WDATA_SI;
    wire   [6:0]     X_ADDR_BIT_SEL_DECODED;
...
//----------------------------
   ...
   // through this buffer.
   //
    DLY4X4 tessent_persistent_cell_EN_ADDR_BIT_INVERSION (
...
endmodule // sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_c1_controller_data_gen
