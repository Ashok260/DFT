...
sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_tdr tdr_inst (
  .reset            (reset),
...
// TDR instance }}}
DLY4X4 tessent_persistent_cell_BIST_SETUP_2_buf (.A(BIST_SETUP_int[2]),.Y(BIST_SETUP[2]));
DLY4X4 tessent_persistent_cell_BIST_SETUP_1_buf (.A(BIST_SETUP_int[1]),.Y(BIST_SETUP[1]));
DLY4X4 tessent_persistent_cell_BIST_SETUP_0_buf (.A(BIST_SETUP_int[0]),.Y(BIST_SETUP[0]));
// SIB sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_controller_sib_tdr_bypass_inst instance {{{
wire tdr_bypass_so;
sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_sib sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_controller_sib_tdr_bypass_inst (
  .reset             (reset),
  .si                (si),
  .capture_en        (capture_en),
  .shift_en          (shift_en),
...
// SIB 0 instance {{{
sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_ctl_sib sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_controller_sib_inst0 (
  .reset             (reset),
  .si                (tdr_bypass_so),
  .capture_en        (capture_en),
  .shift_en          (shift_en),
...
// SIB 0 instance }}}
// SIB sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_controller_sib_ctl_bypass_inst instance {{{
wire sib_ctl_bypass_so;
sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_sib sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_controller_sib_ctl_bypass_inst (
  .reset             (reset),
  .si                (tdr_bypass_so),
  .capture_en        (capture_en),
  .shift_en          (shift_en),
...
wire tck_out_gated;
TLATNTSCAX8 tessent_persistent_cell_GATING_TCK (
  .CK               (tck),
  .SE               (1'b0),
  .E                (to_mbist_tck_en),
  .ECK              (tck_out_gated)
);
  sram_sp_16384d_36w_16m_8b_rtl_tessent_clk_buf tessent_persistent_cell_BUF_C_TCK (
    .a               (tck_out_gated),
    .y               (to_controllers_tck)
  );
  sram_sp_16384d_36w_16m_8b_rtl_tessent_clk_buf tessent_persistent_cell_BUF_I_TCK (
    .a               (tck_out_gated),
    .y               (to_interfaces_tck)
  );
 
// --------- Persistent Buffers for SDC anchors -----------
DLY4X4 tessent_persistent_cell_bistEn_0 (.A(sib_bist_en[0]),.Y(bistEn[0]));
DLY4X4 tessent_persistent_cell_BIST_ASYNC_RESET (.A(BIST_ASYNC_RESET_to_buf),.Y(BIST_ASYNC_RESET));
DLY4X4 tessent_persistent_cell_TCK_MODE (.A(TCK_MODE_to_buf),.Y(TCK_MODE));
DLY4X4 tessent_persistent_cell_BIST_HOLD (.A(BIST_HOLD_latch),.Y(BIST_HOLD));
DLY4X4 tessent_persistent_cell_ENABLE_MEM_RESET_buf (.A(ENABLE_MEM_RESET_int),.Y(ENABLE_MEM_RESET));
DLY4X4 tessent_persistent_cell_REDUCED_ADDRESS_COUNT_buf (.A(REDUCED_ADDRESS_COUNT_int),.Y(REDUCED_ADDRESS_COUNT));
DLY4X4 tessent_persistent_cell_BIST_SELECT_TEST_DATA_buf (.A(BIST_SELECT_TEST_DATA_int),.Y(BIST_SELECT_TEST_DATA));
DLY4X4 tessent_persistent_cell_BIST_ALGO_MODE0_buf (.A(BIST_ALGO_MODE0_int),.Y(BIST_ALGO_MODE0));
DLY4X4 tessent_persistent_cell_BIST_ALGO_MODE1_buf (.A(BIST_ALGO_MODE1_int),.Y(BIST_ALGO_MODE1));
DLY4X4 tessent_persistent_cell_BIST_DIAG_EN_buf (.A(BIST_DIAG_EN_int),.Y(BIST_DIAG_EN));
DLY4X4 tessent_persistent_cell_FL_CNT_MODE0_buf (.A(FL_CNT_MODE0_int),.Y(FL_CNT_MODE0));
DLY4X4 tessent_persistent_cell_FL_CNT_MODE1_buf (.A(FL_CNT_MODE1_int),.Y(FL_CNT_MODE1));
DLY4X4 tessent_persistent_cell_INCLUDE_MEM_RESULTS_REG_buf (.A(INCLUDE_MEM_RESULTS_REG_int),.Y(INCLUDE_MEM_RESULTS_REG));
DLY4X4 tessent_persistent_cell_CHAIN_BYPASS_EN_buf (.A(CHAIN_BYPASS_EN_int),.Y(CHAIN_BYPASS_EN));
// sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap }}}
endmodule
 
module sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_tdr (
// sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_tdr {{{
  input wire reset,
  input wire ijtag_select,
  input wire si,
  input wire capture_en,
...
CLKMX2X6 tessent_persistent_cell_BIST_ASYNC_RESET_mux (.A(tdr_latch6),.B(reset),.S0(ltest_en),.Y(BIST_ASYNC_RESET));
...
module sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_sib (
// sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_controller_sib {{{
   input wire reset,
   input wire ijtag_select,
   input wire si,
   input wire capture_en,
...
module sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_bap_ctl_sib (
// sram_sp_16384d_36w_16m_8b_rtl_tessent_mbist_controller_sib {{{
   input wire reset,
   input wire ijtag_select,
   input wire si,
