...
module sram_sp_16384d_36w_16m_8b_rtl_tessent_sib_1 (
   ...
   CLKMX2X6 tessent_persistent_cell_ltest_reset_mux (
   ...
   DLY4X4 tessent_persistent_cell_ltest_scan_en_buf (
      .A                 ( ltest_scan_en ),
      .Y                 ( ltest_scan_en_buf_out )
   );
   DLY4X4 tessent_persistent_cell_static_clock_control_mode_buf (
      .A                 ( ltest_static_clock_control_mode ),
      .Y                 ( static_clock_control_mode_buf_out )
   );
   DLY4X4 tessent_persistent_cell_clock_sequence_buf_0 (
      .A                 ( ltest_clock_sequence[0] ),
      .Y                 ( clock_sequence_buf_out[0] )
   );
   DLY4X4 tessent_persistent_cell_clock_sequence_buf_1 (
      .A                 ( ltest_clock_sequence[1] ),
      .Y                 ( clock_sequence_buf_out[1] )
   );
   DLY4X4 tessent_persistent_cell_ltest_scan_in_buf (
      .A                 ( ltest_si ),
      .Y                 ( ltest_scan_in_buf_out )
   );
   DLY4X4 tessent_persistent_cell_occ_ctrl_so_buf (
      .A                 ( occ_ctrl_so_buf_in ),
      .Y                 ( occ_ctrl_so )
   );
   sram_sp_16384d_36w_16m_8b_rtl_tessent_clk_buf tessent_persistent_cell_cts_stop_buf (
     .a                  ( ltest_clk ),
     .y                  ( ltest_clk_buf )
   );
   ...
   TLATNTSCAX8 tessent_persistent_cell_occ_clock_gate (
     .ECK                ( occ_clock_out),
     .CK                 ( ltest_clk ),
     .E                  ( occ_ctrl[0] & ltest_occ_en),
     .SE                 ( ltest_scan_en_buf_out)
   );
    
   sram_sp_16384d_36w_16m_8b_rtl_tessent_clk_mux2 tessent_persistent_cell_ltest_clock_mux (
     .a                  ( ijtag_tck ),
     .b                  ( occ_clock_out ),
     .s                  ( ltest_en ),
     .y                  ( ijtag_to_tck )
