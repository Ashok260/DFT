...
set logfile fv/glbl/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/glbl -revised fv_map
...
elaborate_design -golden -root {glbl} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/glbl/fv_map.v.gz
elaborate_design -revised -root {glbl}
...
set_system_mode lec
write_compared_points noneq.compared_points.glbl.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.glbl.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.glbl.rtl.fv_map.rpt
