...
# Generated on: Fri Jun 13 16:53:39 IST 2025 (Fri Jun 13 11:23:39 UTC 2025)
...
set logfile fv/spi2ram/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/spi2ram -revised fv_map
...
elaborate_design -golden -root {spi2ram} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/spi2ram/fv_map.v.gz
elaborate_design -revised -root {spi2ram}
...
#add_name_alias fv/spi2ram/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.spi2ram.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.spi2ram.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.spi2ram.rtl.fv_map.rpt
