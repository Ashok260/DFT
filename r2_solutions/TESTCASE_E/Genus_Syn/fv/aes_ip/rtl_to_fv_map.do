...
# Generated on: Fri Jun 13 17:44:51 IST 2025 (Fri Jun 13 12:14:51 UTC 2025)
...
set logfile fv/aes_ip/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/aes_ip -revised fv_map
...
elaborate_design -golden -root {aes_ip} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/aes_ip/fv_map.v.gz
elaborate_design -revised -root {aes_ip}
...
#add_name_alias fv/aes_ip/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.aes_ip.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.aes_ip.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.aes_ip.rtl.fv_map.rpt
