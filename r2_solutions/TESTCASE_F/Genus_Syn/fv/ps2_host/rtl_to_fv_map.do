...
# Generated on: Fri Jun 13 17:46:40 IST 2025 (Fri Jun 13 12:16:40 UTC 2025)
...
set logfile fv/ps2_host/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/ps2_host -revised fv_map
...
elaborate_design -golden -root {ps2_host} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/ps2_host/fv_map.v.gz
elaborate_design -revised -root {ps2_host}
...
#add_name_alias fv/ps2_host/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.ps2_host.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ps2_host.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ps2_host.rtl.fv_map.rpt
