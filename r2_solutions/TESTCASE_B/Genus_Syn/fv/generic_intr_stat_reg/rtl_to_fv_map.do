...
# Generated on: Fri Jun 13 17:03:51 IST 2025 (Fri Jun 13 11:33:51 UTC 2025)
...
set logfile fv/generic_intr_stat_reg/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/generic_intr_stat_reg -revised fv_map
...
elaborate_design -golden -root {generic_intr_stat_reg} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/generic_intr_stat_reg/fv_map.v.gz
elaborate_design -revised -root {generic_intr_stat_reg}
...
#add_name_alias fv/generic_intr_stat_reg/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.generic_intr_stat_reg.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.generic_intr_stat_reg.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.generic_intr_stat_reg.rtl.fv_map.rpt
