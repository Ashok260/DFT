...
# Generated on: Fri Jun 13 17:03:52 IST 2025 (Fri Jun 13 11:33:52 UTC 2025)
...
set logfile fv/double_sync_high/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/double_sync_high -revised fv_map
...
elaborate_design -golden -root {double_sync_high} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/double_sync_high/fv_map.v.gz
elaborate_design -revised -root {double_sync_high}
...
#add_name_alias fv/double_sync_high/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.double_sync_high.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.double_sync_high.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.double_sync_high.rtl.fv_map.rpt
