...
# Generated on: Fri Jun 13 17:03:42 IST 2025 (Fri Jun 13 11:33:42 UTC 2025)
...
set logfile fv/core/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
set_system_mode lec
write_compared_points noneq.compared_points.core.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.core.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.core.rtl.fv_map.rpt
