...
set logfile fv/generic_tpram/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/generic_tpram -revised fv_map
...
elaborate_design -golden -root {generic_tpram} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/generic_tpram/fv_map.v.gz
elaborate_design -revised -root {generic_tpram}
...
#add_name_alias fv/generic_tpram/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.generic_tpram.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.generic_tpram.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.generic_tpram.rtl.fv_map.rpt
