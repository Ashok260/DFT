...
# Generated on: Fri Jun 13 18:08:20 IST 2025 (Fri Jun 13 12:38:20 UTC 2025)
...
set logfile fv/can_register_syn/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/can_register_syn -revised fv_map
...
elaborate_design -golden -root {can_register_syn} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/can_register_syn/fv_map.v.gz
elaborate_design -revised -root {can_register_syn}
...
#add_name_alias fv/can_register_syn/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.can_register_syn.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.can_register_syn.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.can_register_syn.rtl.fv_map.rpt
