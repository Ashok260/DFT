...
#####################
#check_design -type all -out_file        ${reportDir}/check_design.rpt
...
report_analysis_summary -expanded_summary_clocks                                         > ${reportDir}/analysis_summary.rpt
...
###########################################
## report the metric values to an HTML file
###########################################
um::pop_snapshot_stack
um::create_snapshot -name basic_sta -categories *
