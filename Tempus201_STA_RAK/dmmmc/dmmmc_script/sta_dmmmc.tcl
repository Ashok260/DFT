...
################################
set_delay_cal_mode -SIAware true -siMode signoff                ;# Turn on SI analysis
setSIMode -enable_glitch_report 1                               ;# Turn on glitch analysis
...
report_timing -path_type end_slack_only -max_slack 0 > setup.rpt
report_timing -path_type end_slack_only -max_slack 0 -early > hold.rpt
