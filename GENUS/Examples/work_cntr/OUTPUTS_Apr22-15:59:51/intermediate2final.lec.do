...
# Generated on: Tue Apr 22 15:59:55 IST 2025 (Tue Apr 22 10:29:55 UTC 2025)
...
set_verification_information fv_map_CLOCK_mv_db

read_implementation_information fv/CLOCK -golden fv_map -revised CLOCK_mv
...
read_design -verilog95   -golden -lastmod -noelab fv/CLOCK/fv_map.v.gz
elaborate_design -golden -root {CLOCK}

read_design -verilog95   -revised -lastmod -noelab ./OUTPUTS_Apr22-15:59:51/CLOCK_m.v
elaborate_design -revised -root {CLOCK}

#add_name_alias fv/CLOCK/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/CLOCK/CLOCK_mv.singlebit.original_name.alias.json.gz -revised
