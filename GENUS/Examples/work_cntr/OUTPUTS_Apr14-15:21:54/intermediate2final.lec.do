...
# Generated on: Mon Apr 14 15:21:57 IST 2025 (Mon Apr 14 09:51:57 UTC 2025)
...
set_verification_information fv_map_random_counter_lfsr_mv_db

read_implementation_information fv/random_counter_lfsr -golden fv_map -revised random_counter_lfsr_mv
...
read_library -liberty -both /home/01fe21bec223/DFT_TESSENT/GENUS/work_cntr/../TECHFILES/NangateOpenCellLibrary_slow_conditional_ccs.lib

read_design -verilog95   -golden -lastmod -noelab fv/random_counter_lfsr/fv_map.v.gz
elaborate_design -golden -root {random_counter_lfsr}

read_design -verilog95   -revised -lastmod -noelab ./OUTPUTS_Apr14-15:21:54/random_counter_lfsr_m.v
elaborate_design -revised -root {random_counter_lfsr}

#add_name_alias fv/random_counter_lfsr/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/random_counter_lfsr/random_counter_lfsr_mv.singlebit.original_name.alias.json.gz -revised
