...
// Generated on: Mar 11 2025 17:39:38 IST (Mar 11 2025 12:09:38 UTC)
...
module mcrb(mc_rb_ef1_svld_i, gctl_rclk_orst_n_i, skew_addr_cntr_o,
  ...
  DFFR_X2 \skew_addr_cntr_reg[0] (.RN (gctl_rclk_orst_n_i), .CK
       ...
       (UNCONNECTED3));
  NOR2_X2 g404__2398(.A1 (n_10), .A2 (n_14), .ZN (n_16));
  NOR2_X2 g411__5107(.A1 (n_14), .A2 (skew_addr_cntr_o[0]), .ZN (n_15));
  NOR2_X2 g407__6260(.A1 (n_14), .A2 (n_9), .ZN (n_13));
  NOR2_X2 g412__4319(.A1 (n_14), .A2 (n_2), .ZN (n_12));
  NOR2_X2 g413__8428(.A1 (n_14), .A2 (n_4), .ZN (n_11));
  XNOR2_X2 g406__5526(.A (n_8), .B (skew_addr_cntr_o[4]), .ZN (n_10));
  AOI221_X2 g416__6783(.A (n_6), .B1 (n_5), .B2 (skew_addr_cntr_o[4]),
       .C1 (n_0), .C2 (mc_rb_fuse_vld_q), .ZN (n_14));
  XNOR2_X2 g414__3680(.A (n_7), .B (skew_addr_cntr_o[3]), .ZN (n_9));
  AND2_X2 g415__1617(.A1 (n_7), .A2 (skew_addr_cntr_o[3]), .ZN (n_8));
  AOI21_X2 g417__2802(.A (skew_addr_cntr_o[4]), .B1 (n_1), .B2 (n_5),
       .ZN (n_6));
  XNOR2_X2 g418__1705(.A (n_3), .B (skew_addr_cntr_o[2]), .ZN (n_4));
  AND2_X2 g419__5122(.A1 (n_3), .A2 (skew_addr_cntr_o[2]), .ZN (n_7));
  XNOR2_X2 g420__8246(.A (skew_addr_cntr_o[0]), .B
  ...
  NOR2_X2 g422__7098(.A1 (skew_addr_cntr_o[3]), .A2
       (skew_addr_cntr_o[2]), .ZN (n_5));
  NOR2_X2 g423__6131(.A1 (skew_addr_cntr_o[1]), .A2
       (skew_addr_cntr_o[0]), .ZN (n_1));
  AND2_X2 g424__1881(.A1 (skew_addr_cntr_o[1]), .A2
       (skew_addr_cntr_o[0]), .ZN (n_3));
  INV_X4 g425(.A (mc_rb_ef1_svld_i), .ZN (n_0));
endmodule
