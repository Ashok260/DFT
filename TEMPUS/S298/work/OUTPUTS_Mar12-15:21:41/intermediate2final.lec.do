...
# Generated on: Wed Mar 12 15:21:45 IST 2025 (Wed Mar 12 09:51:45 UTC 2025)
...
set_verification_information fv_map_s298_mv_db

read_implementation_information fv/s298 -golden fv_map -revised s298_mv
...
read_library -liberty -both /home/01fe21bec223/DFT_TESSENT/TEMPUS/work/../TECHFILES/NangateOpenCellLibrary_slow_conditional_ccs.lib

read_design -verilog95   -golden -lastmod -noelab fv/s298/fv_map.v.gz
elaborate_design -golden -root {s298}

read_design -verilog95   -revised -lastmod -noelab ./OUTPUTS_Mar12-15:21:41/s298_m.v
elaborate_design -revised -root {s298}

#add_name_alias fv/s298/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/s298/s298_mv.singlebit.original_name.alias.json.gz -revised
