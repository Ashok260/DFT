...
# Generated on: Tue Mar 11 17:39:38 IST 2025 (Tue Mar 11 12:09:38 UTC 2025)
...
set_verification_information fv_map_mcrb_mv_db

read_implementation_information fv/mcrb -golden fv_map -revised mcrb_mv
...
read_library -liberty -both /home/01fe21bec223/DFT/MCRB/GENUS/work/../TECHFILES/NangateOpenCellLibrary_slow_conditional_ccs.lib

read_design -verilog95   -golden -lastmod -noelab fv/mcrb/fv_map.v.gz
elaborate_design -golden -root {mcrb}

read_design -verilog95   -revised -lastmod -noelab ./OUTPUTS_Mar11-17:39:35/mcrb_m.v
elaborate_design -revised -root {mcrb}

#add_name_alias fv/mcrb/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/mcrb/mcrb_mv.singlebit.original_name.alias.json.gz -revised
